...
public class RestAssuredExercises5Test {
    ...
    public void postCustomerObject_checkReturnedFirstAndLastName_expectSuppliedValues() {
        ...
        Customer reqCustomer = new Customer(firstName, lastName);
        ...
        assertEquals(reqCustomer.getFirstName(), resCustomer.getFirstName());
        assertEquals(reqCustomer.getLastName(), resCustomer.getLastName());
    }
}